...
<body class="w-full min-h-screen relative flex justify-center">
    ...
    <!-- place -->
    <div class="max-w-[60rem] m-auto p-10 flex justify-center flex-col relative z-2 bg-brand-black">
        ...
        <div class="cardContainer w-full flex justify-center gap-10 flex-wrap">
            ...
            <!-- Roome Manager Card -->
            <button onclick="window.location.href='roomsManager.php'" class="bg-brand-purple px-4 py-3  flex justify-center items-center gap-3 rounded-lg">
            ...
            <!-- Users Manager -->
            <button class="bg-brand-purple px-4 py-3  flex justify-center items-center gap-3 rounded-lg">
