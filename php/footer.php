<footer class="border-t-2 border-t-[#383838] mt-5 pb-4 px-8 md:px-[5rem] bg-brand-black relative z-2">
    <div class="footerTop flex justify-evenly flex-col lg:flex-row w-full">
        <div class="ftLeft w-2/5 content-center">
            <!-- LOGO -->
            <svg onclick="window.location.href='index.php'" class="fill-brand-gold aspect-square w-[10rem] md:w-[80%] lg:w-[40%] max-w-[191px] filter drop-shadow-[0_6px_10px_black]" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 779.83 468.89">
        ...
        <div class="ftRight w-full lg:w-3/5 flex flex-col items-center">
            ...
            <div class="credit flex justify-self-center mt-[2rem] md:mt-0">
