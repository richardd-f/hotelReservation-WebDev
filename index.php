...
<body class="w-full relative">
        ...
        <div class="heroContainer absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-3/5 flex justify-center flex-col lg:flex-row items-center gap-[5rem] px-20">
            ...
            <div class=" w-dvw md:w-full lg:w-1/2 ">
                ...
                <div class="flex justify-center px-3 m-auto drop-shadow-xl duration-200 border-[0.25rem] border-brand-gold hover:border-brand-gold-light bg-brand-black h-[3rem] w-fit rounded-full z-3">
                    ...
                    <div class="dateInput h-full w-[14rem] md:w-[17rem] flex items-center justify-center gap-1">
                        ...
                        <input id="date-range" class="border p-2 w-[12rem] md:w-[14.5rem] rounded text-brand-gold bg-transparent border-none placeholder-brand-gold focus:outline-none" placeholder="Select date range" />
                        <script>
                    ...
                    <div x-data="peopleCounter()" class="countPeopleInput h-full w-[12rem] flex items-center justify-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 610 610" class="fill-brand-gold aspect-square h-[50%] overflow-visible">
    ...
    <main class="block max-w-7xl m-auto">
        ...
        <!-- SHOW OFF ROOM -->
        <div id="ourRooms" class="flex flex-col lg:flex-row w-full lg:h-128 bg-brand-black">
